...
export function PlanAnalysisTimeline({ timeline, onLinkClick }: PlanAnalysisTimelineProps) {
  ...
  return (
    <section className="shrink-0 border-t border-foreground/10 bg-background/95 px-4 py-3 backdrop-blur md:px-6 lg:px-10">
      ...
      <div ref={scrollViewportRef} className="app-scroll-pane overflow-x-auto pb-1 pt-2">
              ...
              >
                <PopoverTrigger asChild>
                  ...
                  >
                    <span
                      aria-hidden="true"
                      className="absolute size-5 rounded-full bg-primary/25 opacity-0 group-hover:animate-ping group-hover:opacity-100 motion-reduce:animate-none"
                    />
                    <span className="relative size-2.5 rounded-full bg-primary transition-transform group-hover:scale-125 motion-reduce:transform-none" />
                  </button>
                </PopoverTrigger>
                <PopoverContent
                  align="center"
